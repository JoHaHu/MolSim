...
Particle::Particle(const Particle &other) : position(other.position), velocity(other.velocity), force(other.force), old_force(other.old_force), mass(other.mass), type(other.type) {
...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg, double m_arg, int type_arg)
    : position(x_arg), velocity(v_arg), force({0., 0., 0.}), old_force({0., 0., 0.}), mass(m_arg), type(type_arg) {
  spdlog::trace("Particle generated!");
