...
void torus::
major_radius (::std::auto_ptr< major_radius_type > x)
{
  this->major_radius_.set (x);
}
...
void torus::
minor_radius (::std::auto_ptr< minor_radius_type > x)
{
  this->minor_radius_.set (x);
}
...
void scenario::
checkpoints (::std::auto_ptr< checkpoints_type > x)
{
  this->checkpoints_.set (x);
}
...
void header::
t_start (::std::auto_ptr< t_start_type > x)
{
  this->t_start_.set (x);
}
...
void header::
output_frequency (::std::auto_ptr< output_frequency_type > x)
{
  this->output_frequency_.set (x);
}
...
void header::
output_file (::std::auto_ptr< output_file_type > x)
{
  this->output_file_.set (x);
}
...
void container::
linked_cells (::std::auto_ptr< linked_cells_type > x)
{
  this->linked_cells_.set (x);
}
...
void forces::
lennard_jones (::std::auto_ptr< lennard_jones_type > x)
{
  this->lennard_jones_.set (x);
}
...
celestial_body::
celestial_body (::std::auto_ptr< coordinate_type > coordinate,
...
disc::
disc (::std::auto_ptr< coordinate_type > coordinate,
      ::std::auto_ptr< velocity_type > velocity,
      const radius_type& radius,
      const particleTypeId_type& particleTypeId)
: ::xml_schema::type (),
...
sphere::
sphere (::std::auto_ptr< coordinate_type > coordinate,
        ::std::auto_ptr< velocity_type > velocity,
        const radius_type& radius,
        const mesh_width_type& mesh_width,
        const particleTypeId_type& particleTypeId)
...
torus::
torus (::std::auto_ptr< coordinate_type > coordinate,
       ::std::auto_ptr< velocity_type > velocity,
       const major_radius_type& major_radius,
       const minor_radius_type& minor_radius,
       const particleTypeId_type& particleTypeId)
...
double_helix::
double_helix (::std::auto_ptr< coordinate_type > coordinate,
              ::std::auto_ptr< velocity_type > velocity,
              const radius_type& radius,
              const pitch_type& pitch,
              const height_type& height,
...
scenario::
scenario (::std::auto_ptr< header_type > header,
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::auto_ptr< checkpoints_type > r (
        checkpoints_traits::create (i, f, this));

      if (!this->checkpoints_)
      {
        this->checkpoints_.set (r);
        continue;
      }
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::auto_ptr< checkpoint_type > r (
        checkpoint_traits::create (i, f, this));

      this->checkpoint_.push_back (r);
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::auto_ptr< linked_cells_type > r (
        linked_cells_traits::create (i, f, this));

      if (!this->linked_cells_)
      {
        this->linked_cells_.set (r);
        continue;
      }
    }
...
linked_cells::
linked_cells (::std::auto_ptr< domain_size_type > domain_size,
              ::std::auto_ptr< boundary_conditions_type > boundary_conditions,
              const cutoff_radius_type& cutoff_radius)
: ::xml_schema::type (),
  domain_size_ (domain_size, this),
  boundary_conditions_ (boundary_conditions, this),
...
lennard_jones::
lennard_jones (::std::auto_ptr< particleTypes_type > particleTypes)
: ::xml_schema::type (),
  particleTypes_ (particleTypes, this),
  gravity_ (this),
  particles_ (this)
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    if (n.name () == "boundary_condition" && n.namespace_ ().empty ())
    {
      ...
      this->boundary_condition_.push_back (r);
      continue;
    }
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::auto_ptr< particleType_type > r (
       ...
       ::xml_schema::flags f)
{
  for (; p.more_content (); p.next_content (false))
  {
    ...
    {
      ::std::auto_ptr< torus_type > r (
        torus_traits::create (i, f, this));

      this->torus_.push_back (r);
      continue;
    }
    ...
    {
      ::std::auto_ptr< doubleHelix_type > r (
        doubleHelix_traits::create (i, f, this));

      this->doubleHelix_.push_back (r);
      continue;
    }
...
::std::auto_ptr< ::scenario >
scenario_ (::xml_schema::dom::auto_ptr< ::xercesc::DOMDocument > d,
           ::xml_schema::flags f,
